...
shared_examples_for "a SiteScout api client" do
  before(:all) do
  ...
  describe "configuration" do
    ...
    it "enables you to configure the master secret" do
      subject.client_id.should be_nil
      subject.client_id = "asdf1234"
      subject.client_id.should == "asdf1234"
    end
  end
  ...
  describe "::exchanges" do
    before(:each) do
      ...
      subject.application_secret = "my_application_secret"
    end
